...
BOOST_AUTO_TEST_CASE(computeCenter_test1, * utf::tolerance(0.00001))
{
	...
	cupcfd::geometry::euclidean::EuclideanPoint<double,3> center = Triangle3D<double>::computeCentroid(p1, p2, p3);
...
BOOST_AUTO_TEST_CASE(computeCenter_test2, * utf::tolerance(0.00001))
{
	...
	Triangle3D<double> shape(p1, p2, p3);
	cupcfd::geometry::euclidean::EuclideanPoint<double,3> center = shape.computeCentroid();
...
BOOST_AUTO_TEST_CASE(isPointInsideCentroid_test1,  * utf::tolerance(0.00001))
{
	...
	bool isInside = Triangle3D<double>::isPointInsideCentroid(p1, p2, p3, p1);
...
BOOST_AUTO_TEST_CASE(isPointInsideCentroid_test2,  * utf::tolerance(0.00001))
{
	...
	bool isInside = Triangle3D<double>::isPointInsideCentroid(p1, p2, p3, p2);
	BOOST_CHECK_EQUAL(isInside, true);
}
...
BOOST_AUTO_TEST_CASE(isPointInsideCentroid_test3,  * utf::tolerance(0.00001))
{
	...
	bool isInside = Triangle3D<double>::isPointInsideCentroid(p1, p2, p3, p3);
	BOOST_CHECK_EQUAL(isInside, true);
}
...
BOOST_AUTO_TEST_CASE(isPointInsideCentroid_test4,  * utf::tolerance(0.00001))
{
	...
	bool isInside = Triangle3D<double>::isPointInsideCentroid(p1, p2, p3, p);
	BOOST_CHECK_EQUAL(isInside, true);
}
...
BOOST_AUTO_TEST_CASE(isPointInsideCentroid_test11,  * utf::tolerance(0.00001))
{
	...
	bool isInside = Triangle3D<double>::isPointInsideCentroid(p1, p2, p3, centroid);
	BOOST_CHECK_EQUAL(isInside, true);
}
...
BOOST_AUTO_TEST_CASE(computeNormal_test1,  * utf::tolerance(0.00001))
{
	...
	euc::EuclideanVector<double,3> normalCmp(0.0,0.0,25.0);
