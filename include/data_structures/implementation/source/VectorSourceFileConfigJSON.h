	...
	namespace data_structures
	{
		...
		class VectorSourceFileConfigJSON : public VectorSourceConfigSource<I,T>
		{
			public:
				...
				__attribute__((warn_unused_result))
				cupcfd::error::eCodes getFileFormat(VectorFileFormat * format);
				...
				__attribute__((warn_unused_result))
				cupcfd::error::eCodes buildVectorSourceConfig(VectorSourceConfig<I,T> ** vectorSourceConfig);
		};
	}
}
