	...
	namespace data_structures
	{
		...
		class SparseMatrixSourceFileConfigJSON : public SparseMatrixSourceFileConfigSource<I,T>
		{
			public:
				 ...
				 * @tparam T The datatype of the values generated by the distribution
				 */
				virtual ~SparseMatrixSourceFileConfigJSON();

				// === Overloaded Methods ===

				virtual cupcfd::error::eCodes getFilePath(std::string& filePath);
				virtual cupcfd::error::eCodes getFileFormat(SparseMatrixFileFormat * format);
				virtual void operator=(const SparseMatrixSourceFileConfigJSON<I,T>& source);
				virtual SparseMatrixSourceFileConfigJSON<I,T> * clone();
