	...
	namespace distributions
	{
		...
		class DistributionConfig
		{
			public:
				 ...
				 * @tparam The datatype of the values generated by the distribution
				 */
				DistributionConfig(DistributionConfig<I,T>& source);
				...
				// ToDo: Forcing this to be pure virtual for now to make this an abstract base class....
				 ...
				 * @return Nothing.
				 */
				virtual void operator=(const DistributionConfig<I,T>& source);
